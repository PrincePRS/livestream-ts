...
export const VideoPlayer: React.FC<{ peerId: string }> = React.memo(
  ({ peerId }) => {
    const videoTrack = useHMSStore(
      selectVideoPlaylistVideoTrackByPeerID(peerId)
    );
    const audioTrack = useHMSStore(
      selectVideoPlaylistAudioTrackByPeerID(peerId)
    );
