      ...
      <Wrapper isTile={isTile} data-testid="tile_network">
        ...
        >
          <path
            ...
            fill={getColor(4, downlinkQuality, defaultColor.value)}
          ...
          <path
            ...
            fill={getColor(3, downlinkQuality, defaultColor.value)}
            transform="translate(-.333)"
          />
          <path
            ...
            fill={getColor(2, downlinkQuality, defaultColor.value)}
          />
          <path
            ...
            fill={getColor(1, downlinkQuality, defaultColor.value)}
          />
        </svg>
      </Wrapper>
    </Tooltip>
